...
const Add = ({ career }) => {
  ...
  const [linkEmploye, setlinkEmploye] = React.useState(career.employeLink);
  const [category, setcategory] = React.useState({
    value: career.carrerCategory,
    label: career.carrerCategory,
  });

  const router = useRouter();
  const [description, setDescription] = React.useState(
    career.carrerDescription
  );
  ...
  const filter = async () => {
    let emp = await data?.getAllTeamMember.find(
      (t) => t.id === career.employeLink
    );
    const data1 = {
      value: emp.id,
        ...
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="input-field">
              ...
              <input
                defaultValue={career.carrerVaccancy}
            ...
            <div className="input-field">
              ...
              <input
                defaultValue={career.carrerLocation}
