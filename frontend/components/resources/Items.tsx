...
import { useSortResources } from "@apolloo/actions";
...
const Items: React.FC = ({ active, data, loading }: any) => {
  const [sort, { error: err2, loading: loading3 }] = useSortResources();
  const set = data.getAllResources
  ...
  const data1 = useMemo(() => data.getAllResources, []);
