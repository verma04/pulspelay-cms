...
import { useAddTypes, useEditTypes, useRemoveTypes } from "@apolloo/actions";
function Items({ data: content }) {
  const [add, { data: data2, error, loading }] = useAddTypes();
  const [editTypes, { data, loading: load }] = useEditTypes();
  const [removeTypes] = useRemoveTypes();
