...
import { useAddTopic, useEditTopic, useRemoveTopic } from "@apolloo/actions";
function Items({ data: content }) {
  const [add, { data: data2, error, loading }] = useAddTopic();
  const [editTopic, { data, loading: load }] = useEditTopic();
